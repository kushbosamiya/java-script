...
// function kbc1(question1,answer1) 
// {
//     if (score==100)
//     {
//         console.log(chalk.bold.underline.greenBright('LEVEL 2\n'));
...
// //function-2
// function kbc2(question2,answer2) 
// {
//     if (score==300)
//     {
//         console.log(chalk.bold.underline.greenBright('LEVEL 3\n'));
...
// //function -3
// function kbc3(question3,answer3) 
// {
//     if (score==600) 
//     {
//         console.log(chalk.bold.underline.greenBright('LEVEL 4\n'));
...
kbc('Who is the Father of our Nation?\n',);
kbc('Which is the most sensitive organ in our body?\n','skin');
kbc('India lies in which continent?\n','Asia');
kbc('Which country are the Giza Pyramids in?\n','Egypt');